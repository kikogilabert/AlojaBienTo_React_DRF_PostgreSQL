...
const NotificationBell = () => {
    const { notifications, count_notifications, useNotSeenNotifications, useSetSeenNotifications, useSeenNotifications, useCountNotSeenNotifications } = useNotifications();
            ...
            <OverlayTrigger
                ...
                overlay={
                    <Popover id={`popover-positioned-bottom`}>
                        <Popover.Header as="h3">New Notifications<span className={NotificationBellCSS.count2}>{count_notifications}</span></Popover.Header>
            ...
            >
                <a onClick={handleShow}>
                    <div style={{ position: 'relative', display: 'inline-block' }}>
                        ...
                        <span className={NotificationBellCSS.count}>{count_notifications}</span>
                    </div>
                </a>
            </OverlayTrigger>
        </>
